...
const createParagraph = (text, mark) => {
    const leaf = { text }
    if (mark) {
        leaf[mark] = true
    }
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        text:
                            "select any piece of text and the menu will appear",
...
const HEADINGS = 100
const PARAGRAPHS = 7
export const initialValueHugeDocument = [{ children: [] }]

for (let h = 0; h < HEADINGS; h++) {
    initialValueHugeDocument[0].children.push({
        type: options.h1.type,
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        text:
                            "These are the most common elements, known as blocks:",
                    },
                ],
            },
            {
            ...
            children: [
                {
                    type: options.td.type,
                    children: [
                        createParagraph("# of Lives", options.bold.type),
                    ],
                },
                {
                    type: options.td.type,
